    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <select value={capFilter} onChange={(e) => setCapFilter(e.target.value)} className="px-3 py-1.5 bg-gray-800 border border-gray-700 rounded-lg text-sm">
      ...
      <div className="bg-gray-800 rounded-lg border border-gray-700 overflow-hidden">
        {filtered.length === 0 ? <div className="p-8 text-center text-gray-500">No devices found.</div> : (
          <table className="w-full">
            ...
            <tbody className="divide-y divide-gray-700">
              {filtered.map((dev) => (
                <tr key={dev.name} className="hover:bg-gray-700/50">
                  ...
                  <td className="px-6 py-3 hidden md:table-cell text-sm text-gray-400">{dev.driver || '-'}</td>
                  <td className="px-6 py-3 hidden md:table-cell text-sm text-gray-400 font-mono">{dev.parent || '-'}</td>
