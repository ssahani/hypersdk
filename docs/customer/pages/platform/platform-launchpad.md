...
Launchpad — Machina Platform page at `/platform/launchpad`.
...
- Nav: **Platform → Launchpad** (or spotlight / Finder search)

## What you can do

1. Open `/platform/launchpad` against the Machina daemon (`https://<host>:5092`).
