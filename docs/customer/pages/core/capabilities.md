...
Capabilities — Machina Core page at `/capabilities`.
...
- Route: `/capabilities`
- Nav: **Core → Capabilities** (or spotlight / Finder search)

## What you can do

1. Open `/capabilities` against the Machina daemon (`https://<host>:5092`).
