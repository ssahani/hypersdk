...
Approvals — Machina Platform / Security page at `/platform/zeus/approvals`.
...
- Route: `/platform/zeus/approvals`
- Nav: **Platform / Security → Approvals** (or spotlight / Finder search)

## What you can do

1. Open `/platform/zeus/approvals` against the Machina daemon (`https://<host>:5092`).
