...
Configure Zeus — Machina Platform / Security page at `/platform/zeus/configure`.
...
- Route: `/platform/zeus/configure`
- Nav: **Platform / Security → Configure Zeus** (or spotlight / Finder search)

## What you can do

1. Open `/platform/zeus/configure` against the Machina daemon (`https://<host>:5092`).
