...
Rightsizing — Machina Platform / Security page at `/platform/zeus/rightsizing`.
...
- Route: `/platform/zeus/rightsizing`
- Nav: **Platform / Security → Rightsizing** (or spotlight / Finder search)

## What you can do

1. Open `/platform/zeus/rightsizing` against the Machina daemon (`https://<host>:5092`).
