...
Incident Commander — Machina Platform / Security page at `/platform/zeus/incidents`.
...
- Route: `/platform/zeus/incidents`
- Nav: **Platform / Security → Incident Commander** (or spotlight / Finder search)

## What you can do

1. Open `/platform/zeus/incidents` against the Machina daemon (`https://<host>:5092`).
