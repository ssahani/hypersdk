...
Zeus AI assistant for Machina operations.
...
- Route: `/platform/zeus`
- Nav: **Platform / Security → Zeus AI** (or spotlight / Finder search)

## What you can do

1. Open `/platform/zeus` against the Machina daemon (`https://<host>:5092`).
