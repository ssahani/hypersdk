...
Networking — Machina OpenStack page at `/openstack/networking`.
...
- Route: `/openstack/networking`
- Nav: **OpenStack → Networking** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/networking` against the Machina daemon (`https://<host>:5092`).
