...
Network Topology — Machina OpenStack page at `/openstack/topology`.
...
- Route: `/openstack/topology`
- Nav: **OpenStack → Network Topology** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/topology` against the Machina daemon (`https://<host>:5092`).
