...
Create Instance — Machina OpenStack page at `/openstack/create`.
...
- Route: `/openstack/create`
- Nav: **OpenStack → Create Instance** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/create` against the Machina daemon (`https://<host>:5092`).
