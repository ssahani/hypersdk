...
Glance Images — Machina OpenStack page at `/openstack/images`.
...
- Route: `/openstack/images`
- Nav: **OpenStack → Glance Images** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/images` against the Machina daemon (`https://<host>:5092`).
