...
Overview — Machina OpenStack page at `/openstack`.
...
- Route: `/openstack`
- Nav: **OpenStack → Overview** (or spotlight / Finder search)

## What you can do

1. Open `/openstack` against the Machina daemon (`https://<host>:5092`).
