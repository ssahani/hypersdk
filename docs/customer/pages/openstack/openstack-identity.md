...
Identity — Machina OpenStack page at `/openstack/identity`.
...
- Route: `/openstack/identity`
- Nav: **OpenStack → Identity** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/identity` against the Machina daemon (`https://<host>:5092`).
