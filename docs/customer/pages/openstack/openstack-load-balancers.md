...
Load Balancers — Machina OpenStack page at `/openstack/load-balancers`.
...
- Route: `/openstack/load-balancers`
- Nav: **OpenStack → Load Balancers** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/load-balancers` against the Machina daemon (`https://<host>:5092`).
