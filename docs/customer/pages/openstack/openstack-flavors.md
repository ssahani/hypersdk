...
Flavors — Machina OpenStack page at `/openstack/flavors`.
...
- Route: `/openstack/flavors`
- Nav: **OpenStack → Flavors** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/flavors` against the Machina daemon (`https://<host>:5092`).
