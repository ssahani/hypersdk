...
Volume Snapshots — Machina OpenStack page at `/openstack/volume-snapshots`.
...
- Route: `/openstack/volume-snapshots`
- Nav: **OpenStack → Volume Snapshots** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/volume-snapshots` against the Machina daemon (`https://<host>:5092`).
