...
Security Groups — Machina OpenStack page at `/openstack/security-groups`.
...
- Route: `/openstack/security-groups`
- Nav: **OpenStack → Security Groups** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/security-groups` against the Machina daemon (`https://<host>:5092`).
