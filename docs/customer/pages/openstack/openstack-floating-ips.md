...
Floating IPs — Machina OpenStack page at `/openstack/floating-ips`.
...
- Route: `/openstack/floating-ips`
- Nav: **OpenStack → Floating IPs** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/floating-ips` against the Machina daemon (`https://<host>:5092`).
