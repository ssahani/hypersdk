...
Volumes — Machina OpenStack page at `/openstack/volumes`.
...
- Route: `/openstack/volumes`
- Nav: **OpenStack → Volumes** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/volumes` against the Machina daemon (`https://<host>:5092`).
