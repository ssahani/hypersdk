...
Migrations — Machina OpenStack page at `/openstack/migrations`.
...
- Route: `/openstack/migrations`
- Nav: **OpenStack → Migrations** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/migrations` against the Machina daemon (`https://<host>:5092`).
