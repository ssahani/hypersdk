...
Server Groups — Machina OpenStack page at `/openstack/server-groups`.
...
- Route: `/openstack/server-groups`
- Nav: **OpenStack → Server Groups** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/server-groups` against the Machina daemon (`https://<host>:5092`).
