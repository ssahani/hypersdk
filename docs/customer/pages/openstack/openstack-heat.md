...
Heat Orchestration — Machina OpenStack page at `/openstack/heat`.
...
- Route: `/openstack/heat`
- Nav: **OpenStack → Heat Orchestration** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/heat` against the Machina daemon (`https://<host>:5092`).
