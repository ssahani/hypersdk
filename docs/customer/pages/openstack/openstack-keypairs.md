...
Keypairs — Machina OpenStack page at `/openstack/keypairs`.
...
- Route: `/openstack/keypairs`
- Nav: **OpenStack → Keypairs** (or spotlight / Finder search)

## What you can do

1. Open `/openstack/keypairs` against the Machina daemon (`https://<host>:5092`).
