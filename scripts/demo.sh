...
api POST /vms -d '{"name": "demo-vm", "vcpus": 1, "memory_mb": 512, "disk_gb": 5, "network": "default"}'
...
step "▶️  Start VM"
api POST /vms/demo-vm/start
sleep 2

step "📊 Get VM Metrics"
api GET /metrics/demo-vm

step "📊 All VM Metrics"
api GET /metrics

step "🖥️  Console Info (VNC port)"
api GET /vms/console-info/demo-vm

step "📄 Get VM XML Definition"
echo "  🔗 GET /vms/demo-vm/xml"
curl -s "${API}/vms/demo-vm/xml" | head -20
echo "  ... (truncated)"
sleep 1

step "🔁 Enable Autostart"
api POST /vms/demo-vm/autostart/true

step "📸 Create Snapshot"
api POST /vms/demo-vm/snapshots -d '{"name": "demo-snap", "description": "Demo snapshot"}'

step "📸 List All Snapshots"
api GET /snapshots

step "⏪ Revert to Snapshot"
api POST /vms/demo-vm/snapshots/demo-snap/revert
...
step "⏹️  Shutdown VM"
api POST /vms/demo-vm/shutdown
sleep 3

step "🗑️  Delete Snapshot"
api DELETE /vms/demo-vm/snapshots/demo-snap

step "🗑️  Delete Demo VM"
api DELETE /vms/demo-vm
