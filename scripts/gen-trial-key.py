#!/usr/bin/env python3
"""
Zyvor Sales — Trial Licence Key Generator for Machina

Usage:
  python3 scripts/gen-trial-key.py --who "Acme Corp" [--days 30]

The generated key is sent to the customer. They set it via:
  export MACHINA_LICENSE_KEY="<key>"
  # or place in ~/.config/machina/license.key
...
def main():
    ap = argparse.ArgumentParser(description="Generate a Machina trial licence key")
    ...
    print("  2. Customer sets: export MACHINA_LICENSE_KEY=\"<key>\"")
    print("     OR places in: ~/.config/machina/license.key")
    print("  3. They can verify with: machina-daemon --version\n")
