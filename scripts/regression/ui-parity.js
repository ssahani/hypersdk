...
/**
 * CDP UI: content/policy/marketplace/upgrade/recommendations/parity shells.
 */
...
const log = createLogger(cfg.resultsDir, 'ui-parity');
...
(async () => {
  ...
  console.log(`UI_PARITY_DONE pass=${pass} soft=${soft} fail=${fail}`);
