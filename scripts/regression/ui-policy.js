...
/**
 * CDP UI: policy / templates / marketplace / cost / recommendations shells.
 */
...
const log = createLogger(cfg.resultsDir, 'ui-policy');
...
(async () => {
  ...
  console.log(`UI_POLICY_DONE pass=${pass} soft=${soft} fail=${fail}`);
