...
/**
 * CDP UI: observability / reports / upgrade / GPU / compliance shells.
 */
...
const log = createLogger(cfg.resultsDir, 'ui-obs');
...
(async () => {
  ...
  console.log(`UI_OBS_DONE pass=${pass} soft=${soft} fail=${fail}`);
