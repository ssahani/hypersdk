...
/**
 * CDP UI: applications / fleet desktop / operations / baremetal / autopilot shells.
 */
...
const log = createLogger(cfg.resultsDir, 'ui-apps');
...
(async () => {
  ...
  console.log(`UI_APPS_DONE pass=${pass} soft=${soft} fail=${fail}`);
