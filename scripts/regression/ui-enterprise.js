...
/**
 * CDP UI: enterprise / maintenance / network / finder shells.
 */
...
const log = createLogger(cfg.resultsDir, 'ui-enterprise');
...
(async () => {
  ...
  console.log(`UI_ENTERPRISE_DONE pass=${pass} soft=${soft} fail=${fail}`);
