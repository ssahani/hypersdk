...
/** CDP UI: compliance / enforcement / HA / placement shells. */
...
const log = createLogger(cfg.resultsDir, 'ui-complx');
...
(async () => {
  ...
  console.log(`UI_COMPLX_DONE pass=${pass} soft=${soft} fail=${fail}`);
