...
/** CDP UI: health / doctor / support / recommendations shells. */
...
const log = createLogger(cfg.resultsDir, 'ui-healthx');
...
(async () => {
  ...
  console.log(`UI_HEALTHX_DONE pass=${pass} soft=${soft} fail=${fail}`);
