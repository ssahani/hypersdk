...
/**
 * CDP UI: guest/doctor-adjacent shells — observability, reports, rightsizing,
 * recommendations, host detail, VM detail, system-check.
 */
...
(async () => {
  ...
  console.log(`UI_GUEST_DONE pass=${pass} soft=${soft} fail=${fail}`);
