...
/**
 * CDP UI: alerts / backups / notifications / webhooks / audit shells.
 */
...
const log = createLogger(cfg.resultsDir, 'ui-alerts');
...
(async () => {
  ...
  console.log(`UI_ALERTS_DONE pass=${pass} soft=${soft} fail=${fail}`);
