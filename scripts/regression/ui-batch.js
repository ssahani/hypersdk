...
/** CDP UI: VMs / tasks / activity shells for batch coverage. */
...
const log = createLogger(cfg.resultsDir, 'ui-batch');
...
(async () => {
  ...
  console.log(`UI_BATCH_DONE pass=${pass} soft=${soft} fail=${fail}`);
