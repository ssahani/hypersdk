...
/**
 * CDP UI: diagnose / developer / support / users / settings shells.
 */
...
const log = createLogger(cfg.resultsDir, 'ui-diag');
...
(async () => {
  ...
  console.log(`UI_DIAG_DONE pass=${pass} soft=${soft} fail=${fail}`);
