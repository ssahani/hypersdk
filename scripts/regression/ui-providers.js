...
/**
 * CDP UI: AI providers / blueprints / content / placement / hubs shells.
 */
...
const log = createLogger(cfg.resultsDir, 'ui-providers');
...
(async () => {
  ...
  console.log(`UI_PROVIDERS_DONE pass=${pass} soft=${soft} fail=${fail}`);
