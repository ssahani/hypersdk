...
/** CDP UI: events / tasks / notifications / webhooks / SOC shells. */
...
const log = createLogger(cfg.resultsDir, 'ui-eventx');
...
(async () => {
  ...
  console.log(`UI_EVENTX_DONE pass=${pass} soft=${soft} fail=${fail}`);
