...
/**
 * CDP UI: host ops, placement/maintenance, launchpad, alert-rules, rightsizing.
 */
...
const log = createLogger(cfg.resultsDir, 'ui-host');
...
(async () => {
  ...
  console.log(`UI_HOST_DONE pass=${pass} soft=${soft} fail=${fail}`);
