...
/** CDP UI: fleet hub / finder / storage / networks shells. */
...
const log = createLogger(cfg.resultsDir, 'ui-fleetx');
...
(async () => {
  ...
  console.log(`UI_FLEETX_DONE pass=${pass} soft=${soft} fail=${fail}`);
