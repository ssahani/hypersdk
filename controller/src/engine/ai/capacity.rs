...
fn csv_escape(s: &str) -> String {
    // Neutralize CSV/Excel formula injection: recommendation text can embed
    // user-controlled data (VM names, etc.) and this file is served as an
    ...
    // applying the existing quote/comma escaping.
