...
pub use openstack::{
    ...
    pause_instance, preview_qcow2_upload, reboot_instance, remove_security_group,
    resize_instance, resolve_clouds_yaml_path, resume_instance, snapshot_instance, start_instance,
    stop_instance, suspend_instance, test_connection, unpause_instance, upload_qcow2_to_glance,
    AssociateFloatingIpRequest, AttachVolumeRequest, CreateInstanceRequest, CreateInstanceResponse,
    GlanceUploadPreview, GlanceUploadRequest, GlanceUploadResult, OpenStackAttachedVolume,
