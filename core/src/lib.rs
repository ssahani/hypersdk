...
pub use openstack::{
    ...
    update_image_visibility, update_instance_metadata, update_network, update_port, update_router, update_subnet,
    upload_qcow2_to_glance, upload_volume_to_image, UploadVolumeToImageRequest, UploadVolumeToImageResponse,
    UpdateSubnetRequest,
    ...
    RemoveRouterInterfaceRequest, UpdateNetworkRequest, UpdatePortRequest, UpdateRouterRequest, UpdateVolumeRequest,
