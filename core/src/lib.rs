...
pub use openstack::{
    ...
    extend_cinder_volume, force_delete_instance, get_cinder_volume, get_console_output, get_flavor, get_image, get_instance,
    get_network, get_port, get_quota_summary, get_remote_console, get_router, get_security_group, get_subnet,
    instance_stack_hint,
